...
\begin{figure}[h!]
    ...
    \includegraphics[width=0.02\textwidth]{figs/Label1/1.png}
    &
    \hspace{-1.3em}
    ...
    \includegraphics[width=0.02\textwidth]{figs/Label1/6.png}
    &
    \hspace{-1.3em}
    \scriptsize Dropout
    ...
    \includegraphics[width=0.02\textwidth]{figs/Label1/5.png}
    &
    \hspace{-1.3em}
    \scriptsize Add
    ...
    \caption{Dense Inception-Residual Block}
...
\begin{figure}[h!]
    ...
    \caption{Multi-Scale Input Strategy}
...
The recursive formulation of the decoder is thus: $X_l= DRIC_l (Concat(ConvTranspose3D(X_{l+1}),A(F_l,X_{l+1}))), l = L,\cdots,1,$ where $A(\cdot)$ denotes the attention gate.
...
\begin{figure}[h!]
	...
	\caption{Skip Connections, Attention Gates and Bottlenecks}
...
\item Downsampling:
  \begin{itemize}
  \item The feature map is halved in each spatial dimension using 3D max pooling: $X_l = MaxPool3D(F_l, p = 2)$,  p represents the scaling factor.
  \end{itemize}
...
\begin{itemize}
    \item Upsampling:
The feature map is expanded using transposed 3D convolutions: $U_m = ConvTranspose3D (B_m, k = 2, s = 2)$, where $k$ and $s$ denote kernel size and stride, respectively.
\end{itemize}
...
Another preprocessing step we take is to discard the data where less than 1\% of the volume is covered by the mask, meaning if a data has less than 1\% tumour volume, then we discard that data point entirely**. 
\\
...
\centering
\small
\begin{tabular*}{0.95\linewidth}{@{} l l l @{}}
\toprule
...
\centering
\begin{tabular}{ccc}
\includegraphics[width=0.34\textwidth]{figs/Conture of Tumor Over Flair images/Image 0.png} &
\includegraphics[width=0.34\textwidth]{figs/Conture of Tumor Over Flair images/Image 1.png} &
\includegraphics[width=0.34\textwidth]{figs/Conture of Tumor Over Flair images/Image 28.png} \\

Example 1 & Example 2 & Example 3 \\

\includegraphics[width=0.34\textwidth]{figs/Conture of Tumor Over Flair images/Image 53.png} &
\includegraphics[width=0.34\textwidth]{figs/Conture of Tumor Over Flair images/Image 57.png} & 
\includegraphics[width=0.34\textwidth]{figs/Conture of Tumor Over Flair images/Image 59.png} \\

Example 4 & Example 5 & Example 6 \\

\includegraphics[width=0.34\textwidth]{figs/Conture of Tumor Over Flair images/Image 63.png} &
\includegraphics[width=0.34\textwidth]{figs/Conture of Tumor Over Flair images/Image 66.png} &

\includegraphics[width=0.34\textwidth]{figs/Conture of Tumor Over Flair images/Image 74.png} \\
